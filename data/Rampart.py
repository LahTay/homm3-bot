...
class Rampart(City):
    def __init__(self,
                 name: str = "Rampart",
                 mage_guild: MageGuild = Rampart_Mage_Guild,
                 city_hall: CityHall = Rampart_City_Hall,
                 fort: Fort = Rampart_Fort,
                 marketplace: Marketplace = Rampart_Marketplace,
                 tavern: Tavern = Rampart_Tavern,
                 resource_silo: ResourceSilo = Rampart_Rescource_Silo,
                 blacksmith: Building = Rampart_Blacksmith,
