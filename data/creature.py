...
class Creature:
    def __init__(self, name: str, lvl: int, atc: int, defense: int, dmg: tuple, hp: int, spd: int, value: int, size: int, ammo: int, fly: bool, abilities: tuple, native_terrain: list = None):
        """
        Class representing creature object.

        :param name: Name of the creature
        :param lvl: level of the creature -> 1st not upgraded, 2nd -> upgraded
