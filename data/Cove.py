...
class Cove(City):
    def __init__(self,
                 name: str = "Cove",
                 mage_guild: MageGuild = Cove_Mage_Guild,
                 city_hall: CityHall = Cove_City_Hall,
                 fort: Fort = Cove_Fort,
                 marketplace: Marketplace = Cove_Marketplace,
                 tavern: Tavern = Cove_Tavern,
                 resource_silo: ResourceSilo = Cove_Rescource_Silo,
                 blacksmith: Building = Cove_Blacksmith,
    ...
    def crop_building_names(self):
        ...
        if name == 'frigate':
            ...
            self.t3_generator_lvl.habitat_lvl = 3
