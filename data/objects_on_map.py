...
class DissapearOnClick(ObjectOnMap):
    ...
    def action(self, player, hero, okayImg=0):
        """
        ...
        (player.mercury - 5, player.mercury + 10),(player.ore - 5, player.ore + 10), (player.sulfur - 5, player.sulfur + 10),
        (player.crystal - 5, player.crystal + 10), (player.gems - 5, player.gems + 10),(player.gold - 100, player.gold + 10000))
...
Hut_of_The_Magi = ObjectOnMap(100, "Hut_of_The_Magi")
Junkman = ObjectOnMap(200, "Junkman")
Keymasters_Tent = ObjectOnMap(5000, "Keymasters_Tent")
Learning_Stone = ObjectOnMap(1500, "Learning_Stone")
...
Monolith_One_Way_Entrance = ObjectOnMap(0, "Monolith_One_Way_Entrance")
Monolith_One_Way_Exit = ObjectOnMap(0, "Monolith_One_Way_Exit")
Monolith_Two_Way = ObjectOnMap(0, "Monolith_Two_Way")
Obelisk = ObjectOnMap(350, "Obelisk")
Observation_Tower = ObjectOnMap(750, "Observation_Tower")
Observatory = ObjectOnMap(500, "Observatory")
Pillar_of_Fire = ObjectOnMap(750, "Pillar_of_Fire")
Portal_One_Way_Entrance = ObjectOnMap(0, "Portal_One_Way_Entrance")
Portal_One_Way_Exit = ObjectOnMap(0, "Portal_One_Way_Exit")
Portal_Two_Way = ObjectOnMap(0, "Portal_Two_Way")
Quest_Guard = ObjectOnMap(0, "Quest_Guard")
Redwood_Observatory = ObjectOnMap(750, "Redwood_Observatory")
...
Tree_Of_Knowledge = ObjectOnMap(2500, "Tree_Of_Knowledge")
