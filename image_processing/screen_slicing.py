...
class ScreenStorage:
    def __init__(self):
        ...
        self.units_small = []
        self.queue = []
        self.screen_even = np.empty((960, 1664, 3))
        self.screen_odd = np.empty((960, 1664, 3))
        self.screen =[]
        self.screen_even_old = np.empty((960, 1664, 3))
        self.screen_odd_old = np.empty((960, 1664, 3))
...
def readColors():
    ...
    """
    colors = []
    for filename in os.listdir(os.path.join("colors/")):
        img = cv2.imread(os.path.join("colors/", filename))
