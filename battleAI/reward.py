...
class Reward:
    ...
    def calcReward(self, currUnit, BattleEnv):
        ...
        reward = 100 + 30 * enemiesInRange - retaliation + \
                 - blockedRangedAllies + releasedRangedAllies + damageDealt * 100
        # if self.battle_result == 1:
        #     reward = 1_000_000
        # if self.battle_result == -1:
        #     reward = -1_000_000
        # if BattleEnv.illegalMove == 1:
        #     reward = 0
        return reward, self.battle_result
