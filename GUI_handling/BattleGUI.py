...
def move_mouse_to_tile(x: int, y: int):
    """
    move mouse to tile
...
def cast_spell_battle(id):
    ...
    if id >= 48:
        ...
        time.sleep(0.1)
        mouse.click()
    if 0 <= id <= 11 or 24 <= id <= 35 or 48 < id:
        move_mouse_and_click_battle(705 + 90*(id % 3), 330 + 90*int(id / 3))
    else:
        move_mouse_and_click_battle(1015 + 90 * (id % 3), 330 + 90 * int(id / 3))
